...
public class GameView extends View {
    ...
    public GameView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.com_lanus_game2048_GameView,
                0, 0);

        try {
            backgroundColor = Color.parseColor( a.getString(R.styleable.com_lanus_game2048_GameView_backgroundColor ));
            
            mainRectColor = Color.parseColor( a.getString(R.styleable.com_lanus_game2048_GameView_color) );
            mainRectRoundAngles = a.getInteger(R.styleable.com_lanus_game2048_GameView_roundAngles, 0);

            gridRectColor = Color.parseColor( a.getString(R.styleable.com_lanus_game2048_GameView_gridColor) );
            gridSpacing = a.getInteger(R.styleable.com_lanus_game2048_GameView_gridSpacing, 0);
            gridMargins = a.getInteger(R.styleable.com_lanus_game2048_GameView_gridMargins, 1);
        } finally {
            a.recycle();
        }
        ...
        tileView = new DefaultTileView(context, a.getInteger(R.styleable.com_lanus_game2048_GameView_roundTileAngles, 0));
    }
